...
//Privacy - Photo Library Usage Description = This app requires access to your photo library to save captured images.
//Privacy - Camera Usage Description =  This app requires access to the camera to allow you to take photos and record videos.
...
extension ViewController{
   ...
   private func createOverlay(position: CGRect) -> UIView {
        ...
        overlayView.backgroundColor = .blue.withAlphaComponent(0.9)
